...
from utils.prompts import RESUME_ANALYSIS_PROMPT, COVER_LETTER_PROMPT, INTERVIEW_PREP_PROMPT, INTERVIEW_EVALUATION_PROMPT
...
class GeminiAnalyzer:
    ...
    def evaluate_interview_answer(self, question, sample_answer, user_answer, jd_text, resume_text):
        """Evaluates a candidate's answer to an interview question."""
        if self.mock_mode:
            return {
                "score": 75,
                "feedback": "This is a mock evaluation. Your answer touches on relevant topics but could be structured better using the STAR method.",
                "strengths": ["Clear communication.", "Relevant to the job description."],
                "areas_for_improvement": ["Lack of specific quantifiable metrics.", "Needs more detail on exact actions taken."]
            }
        ...
        try:
            ...
            return {
                "score": 0,
                "feedback": f"Error generating evaluation: {str(e)}",
                "strengths": [],
